...
**Задание со звездочкой:** Интегрировать Splunk или аналог для начального сбора данных. 

**Пример выполнения:** Установить Splunk в Docker на VM1 (сервер мониторинга). Настроить Splunk для сбора системных метрик на VM2 и VM3. Собрать метрики, например, через Splunk Universal Forwarder или другой агент. Создать базовый дашборд в Splunk для отображения CPU и памяти (например, "график использования CPU в процентах и объема свободной памяти в МБ").
